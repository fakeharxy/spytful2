describe("Game", function() {
  ...
  it("should add the correct number of briefcases per player after preparing the game to start", function () {
    var playerCount = 1 + Math.floor(Math.random() * 3);
    for (var i=0; i<playerCount; i++) {
      game.addPlayer("player " + i);
    }
  ...
  it("should add the correct number of extraction points per player after preparing the game to start", function () {
    var playerCount = 1 + Math.floor(Math.random() * 3);
    for (var i=0; i<playerCount; i++) {
      game.addPlayer("player " + i);
    }
